...
void SGC_wp_prams(SGCprams *SGCptr)
{
	...
	The equation to be used is beta = gamma + gamma*1/sl + gamma*(1/sl)^2 + gamma*(1/sl)^3 + gamma*sl + gamma*sl^2 + gamma*sl^3 + gamma*sl^C(0.5);
	...
	*/
	SGCptr->SGCgamma = new NUMERIC_TYPE[32]();
	// beta1
	SGCptr->SGCgamma[0] = C(0.328523411998739);
	SGCptr->SGCgamma[1] = C(-0.136629598093381);
	SGCptr->SGCgamma[2] = C(0.226782890677302);
	SGCptr->SGCgamma[3] = C(0.407317315366405);
	SGCptr->SGCgamma[4] = C(0.0573936111784235);
	SGCptr->SGCgamma[5] = C(-0.000827027398309836);
	SGCptr->SGCgamma[6] = C(7.73363755705211e-06);
	SGCptr->SGCgamma[7] = C(-0.218593761377831);


	//SGCptr->SGCgamma[0] = C(-0.00382640781129463);
	//SGCptr->SGCgamma[1] = C(0.192705773900624);
	//SGCptr->SGCgamma[2] = C(-0.0332165808200565);
	//SGCptr->SGCgamma[3] = C(0.00253291121412471);
	//SGCptr->SGCgamma[4] = C(0.0125545811978110);
	//SGCptr->SGCgamma[5] = C(-5.64900319095837e-05);
	// beta2
	SGCptr->SGCgamma[8] = C(-1.73499845293949);
	SGCptr->SGCgamma[9] = C(1.86961902684339);
	SGCptr->SGCgamma[10] = C(-0.0787095731609086);
	SGCptr->SGCgamma[11] = C(-1.70280956920105);
	SGCptr->SGCgamma[12] = C(-0.236031863429058);
	SGCptr->SGCgamma[13] = C(0.00114799994407101);
	SGCptr->SGCgamma[14] = C(3.43885058357733e-06);
	SGCptr->SGCgamma[15] = C(1.73575973862887);

	//SGCptr->SGCgamma[6] = C(0.693473047865080);
	//SGCptr->SGCgamma[7] = C(0.0998814928897974);
	//SGCptr->SGCgamma[8] = C(-0.112446326301890);
	//SGCptr->SGCgamma[9] = C(0.0179336144901384);
	//SGCptr->SGCgamma[10] = C(0.106947061485761);
	//SGCptr->SGCgamma[11] = C(-0.00634898682856126);
	//SGCptr->SGCgamma[12] = C(0.000113534050231379);
	//SGCptr->SGCgamma[13] = C(0.154047342257332);
	// beta3
	SGCptr->SGCgamma[16] = C(-0.0914107976436178);
	SGCptr->SGCgamma[17] = C(0.0400444500138610);
	SGCptr->SGCgamma[18] = C(0.387741337558434);
	SGCptr->SGCgamma[19] = C(-0.152454059221963);
	SGCptr->SGCgamma[20] = C(-0.0859683978597510);
	SGCptr->SGCgamma[21] = C(0.00121037617690324);
	SGCptr->SGCgamma[22] = C(-1.24573143624190e-05);
	SGCptr->SGCgamma[23] = C(0.515523126751616);

	//SGCptr->SGCgamma[14] = C(0.0786876032500024);
	//SGCptr->SGCgamma[15] = C(0.210468008584605);
	//SGCptr->SGCgamma[16] = C(-0.0562968512037699);
	//SGCptr->SGCgamma[17] = C(0.00619136021801920);
	//SGCptr->SGCgamma[18] = C(-0.0552653878505992);
	//SGCptr->SGCgamma[19] = C(0.000514162069550961);
	//SGCptr->SGCgamma[20] = C(-2.31911554664107e-06);
	//SGCptr->SGCgamma[21] = C(0.383834975591764);
	// beta4
	SGCptr->SGCgamma[24] = C(0.440010360908978);
	SGCptr->SGCgamma[25] = C(-0.291924093276058);
	SGCptr->SGCgamma[26] = C(0.00781944059584046);
	SGCptr->SGCgamma[27] = C(0.0164084553274571);
	SGCptr->SGCgamma[28] = C(0.0337017710333279);
	SGCptr->SGCgamma[29] = C(-0.000464008615742078);
	SGCptr->SGCgamma[30] = C(4.69370047950512e-06);
	SGCptr->SGCgamma[31] = C(-0.204804996998889);

	//SGCptr->SGCgamma[22] = C(0.141643432781455);
	//SGCptr->SGCgamma[23] = C(-0.0722734103471909);
	//SGCptr->SGCgamma[24] = C(0.0195083451137352);
	//SGCptr->SGCgamma[25] = C(-0.00206587357521111);
	//SGCptr->SGCgamma[26] = C(-0.0131507972423559);
	//SGCptr->SGCgamma[27] = C(0.000641712101745405);
	//SGCptr->SGCgamma[28] = C(-1.23372890042230e-05);

	// now for each velaue os SGC1 calculate the beta parameters
	// create arrays for the number of model parameters 
	SGCptr->SGCbeta1 = new NUMERIC_TYPE[SGCptr->NSGCprams]();
	SGCptr->SGCbeta2 = new NUMERIC_TYPE[SGCptr->NSGCprams]();
	SGCptr->SGCbeta3 = new NUMERIC_TYPE[SGCptr->NSGCprams]();
	SGCptr->SGCbeta4 = new NUMERIC_TYPE[SGCptr->NSGCprams]();
	SGCptr->SGCbeta5 = new NUMERIC_TYPE[SGCptr->NSGCprams]();
...
void CalcSGC_A(int gr, NUMERIC_TYPE hflow, NUMERIC_TYPE bf, NUMERIC_TYPE *A, NUMERIC_TYPE *we, const SGCprams *SGCptr)
{
...
NUMERIC_TYPE CalcSGC_UpV(int SGCchan_type, NUMERIC_TYPE h, NUMERIC_TYPE sl, NUMERIC_TYPE c)
{
...
NUMERIC_TYPE CalcSGC_R(int gr, NUMERIC_TYPE h, NUMERIC_TYPE hbf, NUMERIC_TYPE w, NUMERIC_TYPE wbf, NUMERIC_TYPE A, const SGCprams *SGCptr)
{
...
void CalcSGCz(Fnames *Fnameptr, States *Statesptr, Pars *Parptr, Arrays *Arrptr, SGCprams *SGCptr, const int verbose)
{
	FILE *fpb, *fpa, *fp_levee;
	int i, j, p0, gr, ct;
	NUMERIC_TYPE w0, z0, r, p, sl, m, a, zf, dx, dy, levee_tmp, chan_length;
	char dum[80];
	NUMERIC_TYPE no_data = -9999;
	...
	if (Statesptr->SGCchangroup == OFF) // spatially uniform channel parameters
	{
		...
		SGCptr->SGCr = new NUMERIC_TYPE[SGCptr->NSGCprams](); SGCptr->SGCp = new NUMERIC_TYPE[SGCptr->NSGCprams]();
		SGCptr->SGCs = new NUMERIC_TYPE[SGCptr->NSGCprams](); SGCptr->SGCn = new NUMERIC_TYPE[SGCptr->NSGCprams]();
		SGCptr->SGCm = new NUMERIC_TYPE[SGCptr->NSGCprams](); SGCptr->SGCa = new NUMERIC_TYPE[SGCptr->NSGCprams]();
	...
	if (Statesptr->SGCcat_area == ON)
	{
		...
		else
		{
			...
			fscanf(fpa, "%s %" NUM_FMT"", dum, &no_data);
		}
	}
	...
	if (Statesptr->SGCbed == ON)
	{
		...
		else
		{
			...
			fscanf(fpb, "%s %" NUM_FMT"", dum, &no_data);
		}
	}
	//// Open levee files if they exsist
	if (Statesptr->SGClevee == ON)
	{
		fp_levee = fopen(Fnameptr->SGCleveefilename, "r");
		if (fp_levee == NULL)
		{
			if (verbose == ON) printf("Failed to Load SGClevee:\t%s\t using hydraulic geometry\n", Fnameptr->SGCleveefilename);
			fclose(fp_levee); Statesptr->SGClevee = OFF;
		}
		else
		{
			if (verbose == ON) printf("Loading SGClevee:\t%s\t", Fnameptr->SGCleveefilename);
			for (i = 0; i<5; i++) fscanf(fp_levee, "%s %s", dum, dum);
			fscanf(fp_levee, "%s %" NUM_FMT"", dum, &no_data);
		}
	}
	...
	Parptr->SGC_m = getmin(C(1.0), Parptr->SGC_m);
	...
	for (j = 0; j<Parptr->ysz; j++) for (i = 0; i<Parptr->xsz; i++) // loop through model domain
	{
		...
		// Get bed elevation and catchement area from file if they exsist... must read every cell so needs to be before if(w0>C(0.0))
		if (Statesptr->SGCcat_area == ON)
			fscanf(fpa, "%" NUM_FMT" ", &a); // read catchment upstream area from file, if not present will be -1

		if (Statesptr->SGCbed == ON)
			fscanf(fpb, "%" NUM_FMT" ", &zf);     // set zf to bed elevation from file if it exsists
		else
			zf = no_data;  // else set bed elevation from file to no_data

		if (Statesptr->SGClevee == ON)
			fscanf(fp_levee, "%" NUM_FMT" ", &levee_tmp);     // set levee_tmp  if it exsists

		if (w0 > C(0.0) && Arrptr->DEM[p0] != DEM_NO_DATA) // if there is a sub-grid cahnnel
		{
			dx = Arrptr->dx[p0];
			dy = Arrptr->dy[p0];

			// Calculate the length of sub-grid channel in a cell
			chan_length = C(0.0); // set length of channel to zer
			if (i == 0 || Arrptr->SGCwidth[p0 - 1] > C(0.0))           chan_length += C(0.5)*dx;    // check for domain edge or west side trib 
			if (i == (Parptr->xsz - 1) || Arrptr->SGCwidth[p0 + 1] > C(0.0))           chan_length += C(0.5)*dx;    // check for domain edge or east side trib   
			if (j == 0 || Arrptr->SGCwidth[p0 - Parptr->xsz] > C(0.0)) chan_length += C(0.5)*dy;    // check for domain edge or north side trib
			if (j == (Parptr->ysz - 1) || Arrptr->SGCwidth[p0 + Parptr->xsz] > C(0.0)) chan_length += C(0.5)*dy;    // check for domain edge or south side trib
			...
			if (w0 < getmax(dx, dy) && w0*Arrptr->SGCc[p0] > Arrptr->dA[p0])
				Arrptr->SGCc[p0] = Arrptr->dA[p0] / w0;

			if (Statesptr->SGCbed == ON && zf != no_data)	Arrptr->SGCz[p0] = getmin(zf, Arrptr->DEM[p0] - C(0.01));						// If bed elevation is specified in the bedfile set bed elevation bed to the bed file elevation and if above the DEM set to C(0.01) below the DEM
			else if (Statesptr->SGCbfh_mode == ON)		Arrptr->SGCz[p0] = getmin(z0 - p, Arrptr->DEM[p0] - C(0.01));				// If the model is told to use p as depth use p as depth e.g. SGCbfh_mode
			else if (Statesptr->SGCA_mode == ON)			Arrptr->SGCz[p0] = getmin(z0 - p / w0, Arrptr->DEM[p0] - C(0.01));			// If the model is told to use p as channel area use p as area and divide by width e.g. SGCA_mode
			else if (a > 0)								Arrptr->SGCz[p0] = getmin(z0 - r*pow(a, p), Arrptr->DEM[p0] - C(0.01));		// Calculate z using the hydraulic geometry and catchement area, and if above the DEM set to C(0.01) below the DEM
			else											Arrptr->SGCz[p0] = getmin(z0 - r*pow(w0, p), Arrptr->DEM[p0] - C(0.01));		// Calculate z using the hydraulic geometry and channel width, and if above the DEM set to C(0.01) below the DEM
			...
			if (Statesptr->SGClevee == ON) Arrptr->SGCbfH[p0] = Arrptr->SGCbfH[p0] + levee_tmp;
			switch (ct)
			{
			case 1: // Rectangular channel (default) - This model has a top width and bed elevation and top 
			...
			case 2: // h = x^c channel       
				//Arrptr->SGCbfH[p0] = Arrptr->DEM[p0]-Arrptr->SGCz[p0]; // Calculate SGC bank full depth
				Arrptr->SGCc[p0] = Arrptr->SGCc[p0] * Arrptr->SGCwidth[p0] * sl*pow(Arrptr->SGCbfH[p0], C(-1.0) / sl) / (sl + C(1.0)); // calculate SGCc
				Arrptr->SGCbfV[p0] = Arrptr->SGCc[p0] * pow(Arrptr->SGCbfH[p0], C(1.0) / sl + C(1.0)); // calculate bank full volume
				break;  // Break terminates the switch statement
			...
			case 3: // linear slope - This model has a bed elevation, top width and top elevation. 
				...
				Arrptr->SGCc[p0] = C(0.5)*Arrptr->SGCc[p0] * Arrptr->SGCwidth[p0]; // calculate SGCc
				Arrptr->SGCbfV[p0] = Arrptr->SGCc[p0] * Arrptr->SGCbfH[p0]; // calculate bank full volume
				break;	// Break terminates the switch statement  
			...
			case 4: // triangular channel - This model has the bed elevation, top width and top elevation 
				...
				if (Arrptr->DEM[p0] > z0) Arrptr->SGCwidth[p0] = C(2.0)*(Arrptr->DEM[p0] - Arrptr->SGCz[p0])*sl;
				Arrptr->SGCc[p0] = C(0.5)*Arrptr->SGCc[p0] * Arrptr->SGCwidth[p0]; // calculate SGCc
				Arrptr->SGCbfV[p0] = Arrptr->SGCc[p0] * Arrptr->SGCbfH[p0]; // calculate bank full volume
				break;	// Break terminates the switch statement  
			...
			case 5: // parabolic channel 
				//Arrptr->SGCbfH[p0] = Arrptr->DEM[p0] -Arrptr->SGCz[p0]; // Calculate SGC bank full depth
				Arrptr->SGCc[p0] = Arrptr->SGCc[p0] * Arrptr->SGCwidth[p0] * C(2.0)*pow(Arrptr->SGCbfH[p0], C(-0.5)) / (C(2.0) + C(1.0)); // calculate SGCc
				Arrptr->SGCbfV[p0] = Arrptr->SGCc[p0] * pow(Arrptr->SGCbfH[p0], C(3.0) / C(2.0)); // calculate bank full volume
				break;	// Break terminates the switch statement  
			...
			case 6: // No banks
				...
				// check if DEM is channel bed and if so make the channel bed C(0.01) m below the DEM such that the channel is essentially rectangular at DEM height
				//if (Arrptr->SGCz[p0] == Arrptr->DEM[p0]) Arrptr->SGCz[p0]-=C(0.01);
		...
		{
			Arrptr->SGCz[p0] = Arrptr->DEM[p0]; // if no SGC set SGCz to floodplain elevation to allow easy water surface elevation outputs
		}
	...
	if (Statesptr->SGClevee == ON) fclose(fp_levee);
	if (verbose == ON) printf("SGC calc z done.\n");

	// Now that we ahve the sub-grid model created changes are made in the case of a supergrid channel being defined by ChanMask
	// The sub-grid channel bed will not change but the DEM will be set to a big number where the ChanMask is present to prevent the 2D model making calculations
	if (Statesptr->ChanMaskRead == ON)
	{
		for (j = 0; j < Parptr->ysz; j++) for (i = 0; i < Parptr->xsz; i++) // loop through model domain
		{
			p0 = i + j*Parptr->xsz;      // cell index
			if (Arrptr->ChanMask[p0] > 0)
			{
				//NUMERIC_TYPE big_number = 99999.0;
				//Arrptr->DEM[p0] = Arrptr->DEM[p0] + big_number;
				if (Arrptr->SGCwidth[p0] > C(0.0))
				{
					if (Arrptr->DEM[p0] == DEM_NO_DATA) // if DEM is nodata there cannot be a channel
					{
						Arrptr->SGCwidth[p0] = C(0.0);
						printf("Channel removed under DEM NoData at row %i\n", j);
					}
					// if DEM is a value we do nothing here and leave it as it is
				}
				else
				{
					Arrptr->DEM[p0] = DEM_NO_DATA;
					Arrptr->SGCbfH[p0] = C(0.0);
					Arrptr->SGCbfV[p0] = C(0.0);
				}
			}

		}
		if (verbose == ON) printf("SGC DEM updated with ChanMask.\n");
	}
	return;
}
...
{
	int p0, p1, pq0, i, j;
	NUMERIC_TYPE z0, z1, zb0, zb1, h0, h1, fn, w0, w1, dh, Sf, hflow;
...
#pragma omp parallel for private(i,p0,p1,pq0,z0,z1,zb0,zb1,h0,h1,fn,w0,w1,dh,Sf,hflow) 
	for (j = 0; j<Parptr->ysz; j++)
	{
		for (i = 0; i<Parptr->xsz - 1; i++)
		{
			...
			if (Arrptr->Manningsn != NULL) fn = C(0.5)*(Arrptr->Manningsn[p0] + Arrptr->Manningsn[p1]);
			else fn = Parptr->FPn;
			//////////////////SG flows ////////////////////////////////
			...
			if (w0>0 && w1>0)
			{
				if (zb0 + h0>zb1 + h1 && h0>Solverptr->DepthThresh) // Flow from 0->1
				{
					...
					{
						Arrptr->QxSGold[pq0] = (pow(hflow, (C(5.0) / C(3.0)))*Sf / fn)*getmin(w0, w1);
					}
				}
				else if (zb0 + h0<zb1 + h1 && h1>Solverptr->DepthThresh)  // Flow from 1->0
				{
					...
					if (hflow>Solverptr->DepthThresh)
					{
						Arrptr->QxSGold[pq0] = (-pow(hflow, (C(5.0) / C(3.0)))*Sf / fn);
					}
				}
			}
			//////////////////FP flows ////////////////////////////////
			// Correct h for any SGC depth
			if (w0>0) h0 = getmax(h0 - z0 + zb0, C(0.0));
			if (w1>0) h1 = getmax(h1 - z1 + zb1, C(0.0));
			// calculate qfp
			if (z0 + h0>z1 + h1 && h0>Solverptr->DepthThresh) // Flow from 0->1
			{
				...
				if (hflow>Solverptr->DepthThresh)
				{
					Arrptr->Qxold[pq0] = (pow(hflow, (C(5.0) / C(3.0)))*Sf / fn);
				}
			}
		...
		for (i = 0; i<Parptr->xsz; i++)
		{
			...
			if (w0>0 && w1>0)
			{
				if (zb0 + h0>zb1 + h1 && h0>Solverptr->DepthThresh) // Flow from 0->1
				{
					...
					if (hflow>Solverptr->DepthThresh)
					{
						Arrptr->QySGold[pq0] = (pow(hflow, (C(5.0) / C(3.0)))*Sf / fn)*getmin(w0, w1);
					}
				}
				else if (zb0 + h0<zb1 + h1 && h1>Solverptr->DepthThresh)  // Flow from 1->0
				{
					...
					if (hflow>Solverptr->DepthThresh)
					{
						Arrptr->QySGold[pq0] = (-pow(hflow, (C(5.0) / C(3.0)))*Sf / fn);
					}
				}
			}
			//////////////////FP flows ////////////////////////////////
			...
			if (z0 + h0>z1 + h1 && h0>Solverptr->DepthThresh) // Flow from 0->1
			{
				...
				if (hflow>Solverptr->DepthThresh)
				{
					Arrptr->Qyold[pq0] = (pow(hflow, (C(5.0) / C(3.0)))*Sf / fn);
				}
			}
			else if (z0 + h0<z1 + h1 && h1>Solverptr->DepthThresh)  // Flow from 1->0
			{
...
void SGC_FloodplainQ(const States *Statesptr, const Pars *Parptr, const Solver *Solverptr, Arrays *Arrptr, const SGCprams *SGCptr)
{
	int i, j, *wiptr;
	NUMERIC_TYPE h0, h1;
	NUMERIC_TYPE *hptr0, *hptr1, *qptr;
			...
			*qptr = C(0.0);
			if (h0>Solverptr->DepthThresh || h1>Solverptr->DepthThresh)
			{
				if (Statesptr->weirs == ON && *wiptr != -1)
					*qptr = CalcWeirQx(i, j, Parptr, Arrptr, Solverptr, Statesptr, SGCptr);
				else
					*qptr = CalcFPQxSGC(i, j, Statesptr, Parptr, Solverptr, Arrptr, SGCptr);
			}
			else
			{
				Arrptr->Qxold[i + (j*(Parptr->xsz + 1) + 1)] = C(0.0);
				Arrptr->QxSGold[i + (j*(Parptr->xsz + 1) + 1)] = C(0.0);
			}
			qptr++;
			hptr0++;
			wiptr++;
	...
	for (j = 0; j<Parptr->ysz - 1; j++)
	{
		...
		for (i = 0; i<Parptr->xsz; i++)
		{
			...
			*qptr = C(0.0);
			...
			{
				if (Statesptr->weirs == ON && *wiptr != -1)
					*qptr = CalcWeirQy(i, j, Parptr, Arrptr, Solverptr, Statesptr, SGCptr);
				else
					*qptr = CalcFPQySGC(i, j, Statesptr, Parptr, Solverptr, Arrptr, SGCptr);
			}
			else
			{
				Arrptr->Qyold[i + ((j + 1)*(Parptr->xsz + 1))] = C(0.0);
				Arrptr->QySGold[i + ((j + 1)*(Parptr->xsz + 1))] = C(0.0);
			}
			hptr0++;
			hptr1++;
			qptr++;
...
NUMERIC_TYPE CalcFPQxSGC(int i, int j, const States *Statesptr, const Pars *Parptr, const Solver *Solverptr, const Arrays *Arrptr, const SGCprams *SGCptr)
{
	NUMERIC_TYPE z0, z1, h0, h1, Sf = C(0.0), hflow, fn, dh = C(0.0), Q = C(0.0), Qc = C(0.0), q0, g, dt, we = C(0.0), w0, w1, zb0, zb1, qc, A0, A1, R, bf0, bf1, cn, m;
	...
	if (Arrptr->Manningsn != NULL)   fn = C(0.5)*(Arrptr->Manningsn[p0] + Arrptr->Manningsn[p1]); // this could be pre-calculated
	else fn = Parptr->FPn;
	//////////////////SG flows ////////////////////////////////
	// if both cells are a SGC
	if (w0>C(0.0) && w1>C(0.0))
	{
		...
		if (hflow>Solverptr->DepthThresh)
		{
			...
			m = C(0.5)*(SGCptr->SGCm[gr0] + SGCptr->SGCm[gr1]); // get meander coefficient for sub-grid channel
			if (Arrptr->SGCManningsn != NULL)   cn = pow(C(0.5)*(Arrptr->SGCManningsn[p0] + Arrptr->SGCManningsn[p1]), C(2.)); // this could be pre-calculated
			...
			if (A0 < A1) // select the appropriate slope and area based on the smallest area
			{
				...
				Arrptr->QxSGold[pq0] = (qc - g*A0*dt*Sf) / (1 + dt*g*cn*fabs(qc) / (pow(R, C(4.0) / C(3.0))*A0));
				we = w0;
			}
			else
			{
				...
				// Calculate channel flow using inertial wave equation --- in this case Qxold will be in m3s-1 not m2s-1
				Arrptr->QxSGold[pq0] = (qc - g*A1*dt*Sf) / (1 + dt*g*cn*fabs(qc) / (pow(R, C(4.0) / C(3.0))*A1));
				we = w1; // set effective width
			}
			Qc = Arrptr->QxSGold[pq0]; // Update channel flows
		}
		else Arrptr->QxSGold[pq0] = C(0.0); // make sure previous flux is set to zero
	}
	//////////////////FP flows ////////////////////////////////
	...
	{
		// Correct h for any SGC depth
		if (w0>C(0.0)) h0 = getmax(h0 - bf0, C(0.0));
		if (w1>C(0.0)) h1 = getmax(h1 - bf1, C(0.0));
		...
		if (hflow>Solverptr->DepthThresh)
		{
			...
			{
				Arrptr->Qxold[pq0] = (q0 - (g*dt*hflow*Sf)) / (1 + g*dt*fn*fn*fabs(q0) / pow(hflow, (C(7.0) / C(3.0))));//*Parptr->dx;
				//Q= Arrptr->Qxold[pq0]*(Parptr->dx-we); //CCS_deletion
				Q = Arrptr->Qxold[pq0] * (Arrptr->dx[p0] - we);
			}
			else
				Arrptr->Qxold[pq0] = C(0.0); // Set Qxold to zero
		}
		else Arrptr->Qxold[pq0] = C(0.0); // Set Qxold to zero
	}
	else
	{
		//if (Arrptr->Qxold[pq0] != C(0.0))
		//	printf("Qxold reset on large sub grid %" NUM_FMT"\n", Arrptr->Qxold[pq0]);
		Arrptr->Qxold[pq0] = C(0.0);
	}
	...
	{
		//if ((Q-Qc) == C(0.0) || we >= Parptr->dx) Arrptr->Vx[pq0]=C(0.0); //CCS_deletion
		if ((Q - Qc) == C(0.0) || we >= Arrptr->dy[p0])
			Arrptr->Vx[pq0] = C(0.0); // CCS dy[p0] for cell width relative to channel flow in x
		else
		{
...
//-----------------------------------------------------------------------------------
// CALCULATE FLOODPLAIN AND SGC FLOWS
NUMERIC_TYPE CalcFPQySGC(int i, int j, const States *Statesptr, const Pars *Parptr, const Solver *Solverptr, const Arrays *Arrptr, const SGCprams *SGCptr)
{
	NUMERIC_TYPE z0, z1, h0, h1, Sf = C(0.0), hflow, fn, dh = C(0.0), Q = C(0.0), Qc = C(0.0), q0, g, dt, we = C(0.0), w0, w1, zb0, zb1, qc, A0, A1, R, bf0, bf1, cn, m;
	int p0, p1, pq0, gr0, gr1;
	...
	if (w0>C(0.0) && w1>C(0.0))
	{
		...
		if (hflow>Solverptr->DepthThresh)
		{
			...
			if (Arrptr->SGCManningsn != NULL)   cn = pow(C(0.5)*(Arrptr->SGCManningsn[p0] + Arrptr->SGCManningsn[p1]), 2); // this could be pre-calculated
			else cn = SGCptr->SGCn[gr0];
			// calculate Sfch
			dh = zb0 + h0 - zb1 - h1;
			//Sf=-dh/Parptr->dx; //CCS_deletion
			...
			if (A0 < A1) // select the appropriate slope and area based on the smallest area
			{
				...
				R = CalcSGC_R(gr0, hflow, bf0, w0, Arrptr->SGCwidth[p0], A0, SGCptr);
				// Calculate channel flow using inertial wave equation --- in this case Qxold will be in m3s-1 not m2s-1
				Arrptr->QySGold[pq0] = (qc - g*A0*dt*Sf) / (1 + dt*g*cn*fabs(qc) / (pow(R, C(4.0) / C(3.0))*A0));
				we = w0;
			}
			else
			{
				...
				R = CalcSGC_R(gr1, hflow, bf1, w1, Arrptr->SGCwidth[p1], A1, SGCptr);
				// Calculate channel flow using inertial wave equation --- in this case Qxold will be in m3s-1 not m2s-1
				Arrptr->QySGold[pq0] = (qc - g*A1*dt*Sf) / (1 + dt*g*cn*fabs(qc) / (pow(R, C(4.0) / C(3.0))*A1));
				we = w1; // set effective width
			}
			Qc = Arrptr->QySGold[pq0]; // Update channel flows
		}
		else Arrptr->QySGold[pq0] = C(0.0); // make sure previous flux is set to zero
	}
	/////////////////FP flows ////////////////////////////////
	// don't calculate floodplain flow if we (channel width) is greater than cell width, note we is initalised as zero
	//if (we < Parptr->dx) //CCS_deletion
	...
	{
		// Correct h for any SGC depth
		if (w0>0) h0 = getmax(h0 - bf0, C(0.0));
		if (w1>0) h1 = getmax(h1 - bf1, C(0.0));
		// calculate Qfp
		hflow = getmax(z0 + h0, z1 + h1) - getmax(z0, z1);
		if (hflow>Solverptr->DepthThresh)
		{
			...
			if (Statesptr->routing == OFF || fabs(Sf)<Parptr->RouteSfThresh)
			{
				Arrptr->Qyold[pq0] = (q0 - (g*dt*hflow*Sf)) / (1 + g*dt*fn*fn*fabs(q0) / pow(hflow, (C(7.0) / C(3.0))));
				//Q= Arrptr->Qyold[pq0]*(Parptr->dx-we); //CCS_deletion
				Q = Arrptr->Qyold[pq0] * (Arrptr->dy[p0] - we);
			}
			else
				Arrptr->Qyold[pq0] = C(0.0); // Set Qxold to zero
		}
		else Arrptr->Qyold[pq0] = C(0.0); // make sure previous flux is set to zero
	}
	else
	{
		//if (Arrptr->Qyold[pq0] != C(0.0))
		//	printf("Qyold reset on large sub grid %" NUM_FMT"\n", Arrptr->Qxold[pq0]);
		Arrptr->Qyold[pq0] = C(0.0);
	}
	...
	if (Statesptr->voutput == ON)
	{
		//if ((Q-Qc) == C(0.0) || we >= Parptr->dx) Arrptr->Vy[pq0]=C(0.0);// check Qfp is above CCS_deletion
		if ((Q - Qc) == C(0.0) || we >= Arrptr->dx[p0])
			Arrptr->Vy[pq0] = C(0.0); // check Qfp is above  CCS dx[p0] for cell width relative to channel flow in y
		else
		{
...
NUMERIC_TYPE SGC_UpdateH(States *Statesptr, Pars *Parptr, Solver *Solverptr, BoundCs *BCptr, ChannelSegmentType *ChannelSegments, Arrays *Arrptr, SGCprams *SGCptr)
{
	int i, j, pTH, p0, gr;
	NUMERIC_TYPE *qxptr0, *qyptr0, *qyptr1;
	NUMERIC_TYPE dV = C(0.0), himp, ThreadMax = C(0.0), Hmax = C(0.0), Qpnt_pos = C(0.0), Qpnt_neg = C(0.0), Qfree, cn, fn;
...
#pragma omp parallel for private(pTH, dV, himp, Qfree) reduction (+:Qpnt_pos,Qpnt_neg) // Note: should not be more than one point source per cell else further reduction on SGCdVol needed.
	for (int ps_index = 0; ps_index<BCptr->numPS; ps_index++)
	{
		NUMERIC_TYPE Qpnt = C(0.0);
		// Set initial dV and himp as zero
		dV = C(0.0);
		himp = C(0.0);
		// location in vector
		pTH = BCptr->xpi[ps_index] + BCptr->ypi[ps_index] * Parptr->xsz;
		// different boundary conditions
		if (BCptr->PS_Ident[ps_index] == QFIX4)
			dV = BCptr->PS_Val[ps_index] * Q_multiplier*Solverptr->Tstep; // QFIX // Calculate change in volume
		else if (BCptr->PS_Ident[ps_index] == QVAR5)
			dV = InterpolateTimeSeries(BCptr->PS_TimeSeries[ps_index], Solverptr->t)*Q_multiplier*Solverptr->Tstep; // QVAR // Calculate change in volume
		else if (BCptr->PS_Ident[ps_index] == FREE6) // point free boundary
		{
			if (Arrptr->H[pTH]>Solverptr->DepthThresh)
			{
				...
				CalcSGC_pointFREE(Arrptr->H[pTH], Arrptr->SGCwidth[pTH], BCptr->PS_Val[ps_index], Solverptr->DepthThresh, Solverptr->Tstep, getmin(Arrptr->dx[pTH], Arrptr->dy[pTH]), Solverptr->g, cn, fn, Arrptr->SGCbfH[pTH], Arrptr->SGCgroup[pTH], -1, &BCptr->PS_Q_FP_old[ps_index], &Qfree, &BCptr->PS_Q_SG_old[ps_index], SGCptr);
		...
		Qpnt = dV / Solverptr->Tstep; // Update Qpoint
		if (Qpnt>0) 
			Qpnt_pos += Qpnt;
		else 
			Qpnt_neg += Qpnt;
...
#pragma omp parallel for private( i,qxptr0,qyptr0,qyptr1,dV,ThreadMax, p0, gr)
	for (j = 0; j<Parptr->ysz; j++)
	{
		...
		for (i = 0; i<Parptr->xsz; i++)
		{
			...
			Arrptr->SGCdVol[p0] = C(0.0); // rest SGCdVol to zero
			if (dV != C(0.0)) // if volume has changed 
			{
				Arrptr->SGCVol[p0] += dV; // Add dV to Vol. This is now the total volume.
				Arrptr->SGCVol[p0] = getmax(Arrptr->SGCVol[p0], C(0.0)); // if volume has gone negative set to zero, should not happen so will result in mass balance error
				if (Arrptr->SGCVol[p0] > C(0.0))
				{
					gr = Arrptr->SGCgroup[p0]; // channel group number
					/* //CCS_deletion
					if (Arrptr->SGCwidth[p0] == C(0.0))														Arrptr->H[p0] = Arrptr->SGCVol[p0]/Parptr->dA; // there is no sub-grid channel so normal updateH
					...
					*/
					if (Arrptr->SGCwidth[p0] == C(0.0))
						Arrptr->H[p0] = Arrptr->SGCVol[p0] / Arrptr->dA[p0]; // there is no sub-grid channel so normal updateH
					else if (Arrptr->SGCVol[p0] >= Arrptr->SGCbfV[p0] && Arrptr->SGCwidth[p0] < C(0.5)*(Arrptr->dx[p0] + Arrptr->dy[p0]))
						Arrptr->H[p0] = Arrptr->SGCbfH[p0] + (Arrptr->SGCVol[p0] - Arrptr->SGCbfV[p0]) / Arrptr->dA[p0]; // there is a sub-grid channel but its over bank // Note need to include check for SGCwidth < cell width to make sure out of bank volume is not accounted for in cells with channels wider than a cell
					else
						Arrptr->H[p0] = CalcSGC_UpH(SGCptr->SGCchantype[gr], Arrptr->SGCVol[p0], SGCptr->SGCs[gr], Arrptr->SGCc[p0]); // there is a sub-grid channel and its within bank
				}
				else Arrptr->H[p0] = C(0.0); // make sure H is zero if Vol is zero
			}
...
#pragma omp parallel for private(pTH, dV, himp, gr) reduction (+:Qpnt_pos,Qpnt_neg) // Note: should not be more than one point source per cell else further reduction on SGCdVol
	for (int ps_index = 0; ps_index<BCptr->numPS; ps_index++)
	{
		NUMERIC_TYPE Qpnt = C(0.0);
		// Set initial dV and himp as zero
		...
		pTH = BCptr->xpi[ps_index] + BCptr->ypi[ps_index] * Parptr->xsz;
		// different boundary conditions
		if (BCptr->PS_Ident[ps_index] == HFIX2 || BCptr->PS_Ident[ps_index] == HVAR3) // HFIX or HVAR
		{
			if (BCptr->PS_Ident[ps_index] == HFIX2)
				himp = BCptr->PS_Val[ps_index]; // HFIX
			else
				himp = InterpolateTimeSeries(BCptr->PS_TimeSeries[ps_index], Solverptr->t); // HVAR
			if (Arrptr->SGCwidth[pTH] > C(0.0))
			{
				// sub-grid channel
...
//#pragma omp critical
			{
				Hmax = getmax(Hmax, Arrptr->H[p0]);
			}

		}
	}
	if (fabs(Hmax - hmax_prev) > 1e-7)
	{
		printf("error in old hmax calc\n");
	}

	// save Qpoint
	BCptr->Qpoint_pos = Qpnt_pos;
	BCptr->Qpoint_neg = Qpnt_neg;
...
void SGC_BCs(const States *Statesptr, const Pars *Parptr, const Solver *Solverptr, const BoundCs *BCptr, const ChannelSegmentType *ChannelSegments, Arrays *Arrptr, const SGCprams *SGCptr)
{
	...
	NUMERIC_TYPE surface_elevation0, h1, z1, hflow, fn, dh, Sf, g, w0, zb0, Qfp = C(0.0), A, R, cn, cell_length, cell_width;
	NUMERIC_TYPE *qptr, *qoldptr, *qSGoldptr;
	NUMERIC_TYPE Q_multiplier = C(1.0);
	...
	{
		if (BCptr->BC_Ident[BCi] != NONE0) // if BCi = 0 do nothing
		{
			...
			{	// N(j=0) edge
				...
				//int j = (int)floor((double)p0 / Parptr->xsz);
				//int i = p0 - j*Parptr->xsz;
				//printf("BCNorth %d, %d\n", i, j);
			}
			...
			if (edge == 1 || edge == 3) // N or S boundary; assume flow is N-S or S-N
			{
				...
				cell_width = Arrptr->dx[p0];
			}
			if (edge == 2 || edge == 4) // E or W boundary; assume flow is E-W or W-E
			{
				cell_length = Arrptr->dx[p0];
				cell_width = Arrptr->dy[p0];
			}

			// Now calculate flows
			if (BCptr->BC_Ident[BCi] == FREE1) // FREE boundary
			{
				if (Arrptr->H[p0]>Solverptr->DepthThresh)
				{
					...
					// Calculate channel flow using inertial wave equation --- in this case Qxold will be in m3s-1 not m2s-1
					*qSGoldptr =  sign* (fabs(*qSGoldptr)+fabs(g*Solverptr->Tstep*A*Sf)) / (1+Solverptr->Tstep*g*cn*fabs(*qSGoldptr) / (pow(R,C(4.0)/C(3.0))*A) );
					hflow = getmax(hflow-Arrptr->SGCbfH[p0], C(0.0)); // reduce hflow to account for channel
					}
					else *qSGoldptr = C(0.0);
					...
					// calculate FP flow
					*qoldptr=sign*(fabs(*qoldptr)+fabs(g*Solverptr->Tstep*hflow*Sf))/ (1+g*Solverptr->Tstep*fn*fn*fabs(*qoldptr)/(pow(hflow,(C(7.)/C(3.)))));
					}
					else *qoldptr=C(0.0);
			...
			// HFIX & HVAR boundary
			if (BCptr->BC_Ident[BCi] == HFIX2 || BCptr->BC_Ident[BCi] == HVAR3)
			{
				if (Arrptr->H[p0]>Solverptr->DepthThresh)
				{
					if (BCptr->BC_Ident[BCi] == HFIX2) // boundary depth for HFIX
						surface_elevation0 = BCptr->BC_Val[BCi];
					else // boundary depth for HVAR
						surface_elevation0 = InterpolateTimeSeries(BCptr->BC_TimeSeries[BCi], Solverptr->t);
					h1 = Arrptr->H[p0];        // cell depth
					z1 = Arrptr->DEM[p0];      // FP elevation
					w0 = Arrptr->SGCwidth[p0]; // SGC width

					if (w0>C(0.0)) //  check for sub-grid channel
					{
						// channel present
						zb0 = Arrptr->SGCz[p0]; // channel bed
						hflow = getmax(h1, surface_elevation0 - zb0); // use max of cell depth and boundary depth
						dh = surface_elevation0 - (zb0 + h1);
						gr = Arrptr->SGCgroup[p0];
						...
						R = CalcSGC_R(gr, hflow, Arrptr->SGCbfH[p0], w0, Arrptr->SGCwidth[p0], A, SGCptr); // calculate hydraulic radius for SGC
						// Calculate channel flow using inertial wave equation --- in this case Qxold will be in m3s-1 not m2s-1
						*qSGoldptr = ((*qSGoldptr) - g*Solverptr->Tstep*A*Sf) / (1 + Solverptr->Tstep*g*cn*fabs(*qSGoldptr) / (pow(R, C(4.0) / C(3.0))*A));
						hflow = getmax(hflow - Arrptr->SGCbfH[p0], C(0.0)); // reduce hflow to account for channel
					}
					else 
						hflow = getmax(h1, surface_elevation0 - z1);
					// multiply flux by -sign and use absolute value of q0 to get flux directions correctly assigned at boundaries
					// fabs on Sf and q0 always results in positive or no flow... sign then sorts out the direction(jcn)
					...
					if (hflow>Solverptr->DepthThresh && w0 < cell_width)
					{
						...
						dh = surface_elevation0 - (h1 + z1 - Arrptr->SGCbfH[p0]);
						//if (edge == 1 || edge == 4) Sf=-dh/Parptr->dx; //CCS_deletion
						//else Sf=dh/Parptr->dx; //CCS_deletion
						Sf = dh / cell_length;
						if (edge == 1 || edge == 4) Sf = -Sf;
						// calculate FP flow
						*qoldptr = ((*qoldptr) - g*Solverptr->Tstep*hflow*Sf) / (1 + g*Solverptr->Tstep*fn*fn*fabs(*qoldptr) / (pow(hflow, (C(7.) / C(3.)))));
...
{
	int i, j, p0, gr;
	NUMERIC_TYPE bfh, V, cell_evap, h0, evap_rate, h_old, loc_evap_loss = C(0.0);

	evap_rate = InterpolateTimeSeries(Arrptr->evap, Solverptr->t); //constant rate across whole floodplain
	// calculate evaporation depth
	const NUMERIC_TYPE const_cell_evap = evap_rate * Solverptr->Tstep; //rate for depth, not area
	...
	for (j = 0; j<Parptr->ysz; j++)
	{
		for (i = 0; i<Parptr->xsz; i++)
		{
			...
			if (h0 > Solverptr->DepthThresh) // There is water to evaporate
				//if(h0 > C(0.0)) // There is water to evaporate (allow cell to completly dry TFD)
			{
				cell_evap = const_cell_evap;
				...
				//Arrptr->H[p0]=h0; TFD this causes inconsistancies
				// get bankfull depth
				...
				if (Arrptr->SGCwidth[p0] > C(0.0) && h0 < bfh)
				{
					// sub-grid channel evap or transition evap
					//if (h_old < Arrptr->SGCbfH[p0] || Arrptr->SGCwidth[p0] > Parptr->dx) //CCS_deletion 
					if (h_old < Arrptr->SGCbfH[p0] || Arrptr->SGCwidth[p0] >= C(0.5)*(Arrptr->dx[p0] + Arrptr->dy[p0]))
					{
...
{
	int i, j, p0;
	NUMERIC_TYPE rain_rate, V, loc_rainfall_total = C(0.0);

	rain_rate = InterpolateTimeSeries(Arrptr->rain, Solverptr->t);//constant rate across whole floodplain
...
{
	int i, j, p0, p1;
	NUMERIC_TYPE cell_rain, rain_rate, h0, h1, z0, z1, dh, Sfy, Sfx, V, flow, flowV, flow_fraction;
		...
		for (i = 0; i<Parptr->xsz; i++)
		{
			...
			if (Arrptr->DEM[p0] != 1e10)
			{
				...
				if (Arrptr->H[p0]>0) // Only proceed with rest of loop if cell is wet:
				{
					...
					if (i == Parptr->xsz - 1) Sfx = C(0.0); // boundary cell, don't calc Sfx:
					else
					{
						p1 = i + 1 + j*Parptr->xsz;
						z1 = Arrptr->DEM[p1];
					...
					if (j == Parptr->ysz - 1) Sfy = C(0.0); // boundary cell, don't calc Sfy:
					else
					{
						p1 = i + (j + 1)*Parptr->xsz;
						z1 = Arrptr->DEM[p1];
					...
					if (Arrptr->SGCwidth[p0] == C(0.0)) // if not subgrid channel cell
					{
						h0 = Arrptr->H[p0];
						if (h0<Solverptr->DepthThresh || Sfy >= Parptr->RouteSfThresh || Sfx >= Parptr->RouteSfThresh)
						{
							...
							if (h1<0) { h1 = C(0.0); }	// If h1 negative due to below bankful SG channel cell, set h1 to zero 
							...
							if (flow_fraction > 1)
								flow_fraction = 1; // prevent flow fraction>1 (should never happen!)
...
NUMERIC_TYPE CalcSGC_UpH(int SGCchan_type, NUMERIC_TYPE V, NUMERIC_TYPE sl, NUMERIC_TYPE c)
{
...
void CalcSGC_pointFREE(NUMERIC_TYPE hflow, NUMERIC_TYPE w0, NUMERIC_TYPE Sf, NUMERIC_TYPE DT, NUMERIC_TYPE Tstep, NUMERIC_TYPE cell_width, NUMERIC_TYPE g, NUMERIC_TYPE cn, NUMERIC_TYPE fn, NUMERIC_TYPE SGCbfH, int gr, int sign, NUMERIC_TYPE *qoldptr, NUMERIC_TYPE *qptr, NUMERIC_TYPE *qSGoldptr, const SGCprams *SGCptr)
{
	NUMERIC_TYPE A, R, wbfH;
	...
	if (w0>C(0.0)) // channel present
	{
		...
		// Calculate channel flow using inertial wave equation --- in this case Qxold will be in m3s-1 not m2s-1
		*qSGoldptr = sign* (fabs(*qSGoldptr) + fabs(g*Tstep*A*Sf)) / (1 + Tstep*g*cn*fabs(*qSGoldptr) / (pow(R, C(4.0) / C(3.0))*A));
		hflow = getmax(hflow - SGCbfH, C(0.0)); // reduce hflow to account for channel
	}
	else *qSGoldptr = C(0.0);
	// multiply flux by -sign and use absolute value of q0 to get flux directions correctly assigned at boundaries
	// fabs on Sf and q0 always results in positive or no flow... sign then sorts out the direction(jcn)
	...
	{
		// calculate FP flow
		*qoldptr = sign*(fabs(*qoldptr) + fabs(g*Tstep*hflow*Sf)) / (1 + g*Tstep*fn*fn*fabs(*qoldptr) / (pow(hflow, (C(7.) / C(3.)))));
	}
	else *qoldptr = C(0.0);
	//*qptr= (*qSGoldptr) + (*qoldptr) * (Parptr->dx-w0); //Combine SGC and floodplain flows //CCS_deletion
	*qptr = (*qSGoldptr) + (*qoldptr) * (cell_width - w0);
