...
NUMERIC_TYPE CalcFPQxAcc(int i,int j,States *Statesptr,Pars *Parptr,Solver *Solverptr,Arrays *Arrptr)
{
...
NUMERIC_TYPE CalcFPQyAcc(int i,int j,States *Statesptr,Pars *Parptr,Solver *Solverptr,Arrays *Arrptr)
{
  NUMERIC_TYPE z0,z1,h0,h1,Sf=C(0.0),hflow,fn,dh=C(0.0),Q=C(0.0),q0,g,dt;
  int p0,p1,pq0;
...
NUMERIC_TYPE CalcMaxH(Pars *Parptr, Arrays *Arrptr)
{
